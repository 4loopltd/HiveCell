...
| `docs/Enhancing the Self-Evolving Cognitive Mesh V0.1.pdf` | 100% AI generated reasearch report             |
| `audio/Decoding the Self-Evolving Cognitive Mesh.mp3`      | AI generated audio discussion                  |
| `specs/hivecell-manifest.schema.json`                      | Draft schema for Hive Cell metadata            |
| `notes/`                                                   | Design sketches, diagrams, and notes (WIP)     |
| `The Self-Evolving Cognitive Mesh.html`                    | Site                                           |
